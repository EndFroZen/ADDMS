...
export default function ForgotPassword() {
    ...
    async function handleSubmit() {
        if (!secretCode || !newPassword || !confirmPassword) {
        ...
        try {
            ...
            if (res.ok) {
                ...
                setMessage(result.message || "❌ Invalid secret code");
                setErrors(true);
            }
        } catch (err) {
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-100">
            <div className="bg-white rounded-xl shadow-xl p-10 w-full max-w-md border border-gray-300">
                ...
                <h1 className="text-center text-black text-2xl font-semibold mb-1">Forgot Password</h1>
                <p className="text-center text-gray-400 text-sm mb-5">
                    Enter the secret code you saved during registration to reset your password.
                </p>

                {message && (
                    <p className={`text-center text-sm mb-4 ${errors ? "text-red-500" : "text-green-500"}`}>
                        {message}
                    </p>
                )}
                ...
                <div className="space-y-4">
                    <div>
                        <label htmlFor="secretCode" className="text-black text-sm">Secret Code</label>
                        <input
                            type="text"
                            id="secretCode"
                            value={secretCode}
                            ...
                            required
                            className={`border mt-1 w-full px-4 py-2 text-black rounded-md placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-orange-500 ${errors ? "border-red-500" : "border-gray-300"}`}
                    ...
                    <button
                        ...
                        className="w-full bg-gradient-to-r from-orange-400 to-orange-500 text-white py-3 rounded-md font-medium hover:opacity-90 transition"
                    >
                        Reset Password
                    </button>
                </div>
                ...
                <div className="mt-6 text-center">
                    <a href="/login" className="text-sm text-orange-500 hover:underline">
                        Back to login
                    </a>
                </div>
